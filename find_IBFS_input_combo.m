function [tableau, vars_in_basis, complementary_positions, basis_lookup] = find_IBFS_alternate_input_combo(A, b, x_mu_combo, x_dim)
...
vars_in_basis = vars_in_basis + x_mu_combo;
